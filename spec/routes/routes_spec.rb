...
RSpec.describe 'Routing', type: :routing do
  ...
  it do
    expect(get: cancel_user_registration_path)
      .to route_to(controller: 'registrations', action: 'cancel')
  end

  it do
    expect(get: new_user_registration_path)
      .to route_to(controller: 'registrations', action: 'new')
  end

  it do
    expect(get: edit_user_registration_path)
      .to route_to(controller: 'registrations', action: 'edit')
  end

  it do
    expect(patch: user_registration_path)
      .to route_to(controller: 'registrations', action: 'update')
  end
  ...
  it do
    expect(delete: user_registration_path)
      .to route_to(controller: 'registrations', action: 'destroy')
  end

  it do
    expect(post: user_registration_path)
      .to route_to(controller: 'registrations', action: 'create')
  end
